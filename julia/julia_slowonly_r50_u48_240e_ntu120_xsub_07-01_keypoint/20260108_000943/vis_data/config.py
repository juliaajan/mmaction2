ann_file_test = 'julia/wlasl_test_combined.pkl'
ann_file_train = 'julia/wlasl_train_combined.pkl'
ann_file_val = 'julia/wlasl_val_combined.pkl'
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='julia/wlasl_test_combined.pkl',
        pipeline=[
            dict(
                clip_len=48,
                num_clips=10,
...
train_dataloader = dict(
    ...
    dataset=dict(
        dataset=dict(
            ann_file='julia/wlasl_train_combined.pkl',
            pipeline=[
...
val_dataloader = dict(
    batch_size=16,
    dataset=dict(
        ann_file='julia/wlasl_val_combined.pkl',
        pipeline=[
            dict(
                clip_len=48,
                num_clips=1,
...
work_dir = 'work_dirs/julia_slowonly_r50_u48_240e_ntu120_xsub_07-01_keypoint'
