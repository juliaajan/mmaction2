ann_file_test = 'wlasl_test_combined.pkl'
ann_file_train = 'wlasl_train_combined.pkl'
ann_file_val = 'wlasl_val_combined.pkl'
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='wlasl_test_combined.pkl',
        pipeline=[
            dict(
                clip_len=48,
                num_clips=10,
...
train_dataloader = dict(
    ...
    dataset=dict(
        dataset=dict(
            ann_file='wlasl_train_combined.pkl',
            pipeline=[
...
val_dataloader = dict(
    batch_size=16,
    dataset=dict(
        ann_file='wlasl_val_combined.pkl',
        pipeline=[
            dict(
                clip_len=48,
                num_clips=1,
