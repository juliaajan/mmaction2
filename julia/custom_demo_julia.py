...
def parse_args():
    ...
    parser.add_argument(
        '--config',
        default=('julia/slowonly_r50_8xb16-u48-240e_ntu60-xsub-keypoint_custom_julia.py'),
        help='skeleton model config file path')
    parser.add_argument(
        '--checkpoint',
        default=('work_dirs/julia_slowonly_r50_u48_240e_ntu120_xsub_07-01_keypoint/best_acc_top1_epoch23.pth'),
